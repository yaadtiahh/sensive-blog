...
def post_detail(request, slug):
    post = Post.objects.annotate(Count("comments"), Count("likes")).get(slug=slug)
    serialized_comments = []
    ...
    posts = Post.objects.annotate(likes_count=Count("likes")).prefetch_related('author').order_by('-likes_count')
